...
const std::vector<Opcode> nonExtendedOpcodes = {
        ...
        Opcode{0x80, "ADD A, B", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.B());
            return 0;
        }},
        Opcode{0x81, "ADD A, C", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.C());
            return 0;
        }},
        Opcode{0x82, "ADD A, D", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.D());
            return 0;
        }},
        Opcode{0x83, "ADD A, E", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.E());
            return 0;
        }},
        Opcode{0x84, "ADD A, H", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.H());
            return 0;
        }},
        Opcode{0x85, "ADD A, L", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.L());
            return 0;
        }},
        Opcode{0x86, "ADD A, [HL]", 1, 8, false, [](CPU& cpu, SPBus& bus) {
            cpu.addR8(bus->read(cpu.HL()));
            return 0;
        }},
        Opcode{0x87, "ADD A, A", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.addR8(cpu.A());
            return 0;
        }},
        Opcode{0x88, "ADC A, B", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.B());
            return 0;
        }},
        Opcode{0x89, "ADC A, C", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.C());
            return 0;
        }},
        Opcode{0x8A, "ADC A, D", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.D());
            return 0;
        }},
        Opcode{0x8B, "ADC A, E", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.E());
            return 0;
        }},
        Opcode{0x8C, "ADC A, H", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.H());
            return 0;
        }},
        Opcode{0x8D, "ADC A, L", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.L());
            return 0;
        }},
        Opcode{0x8E, "ADC A, [HL]", 1, 8, false, [](CPU& cpu, SPBus& bus) {
            cpu.adcR8(bus->read(cpu.HL()));
            return 0;
        }},
        Opcode{0x8F, "ADC A, A", 1, 4, false, [](CPU& cpu, SPBus&) {
            cpu.adcR8(cpu.A());
            return 0;
        }},
};
